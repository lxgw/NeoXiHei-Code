...
### 字体授权兼容性说明
- 旧版「M+ 1M」「M+ 2M」采用 [M+ FONTS 自有授权方式](https://spdx.org/licenses/mplus)（旧版 M+ 自有授权条款实质等效于 [0BSD](https://spdx.org/licenses/0BSD)；[新版 M+ 字体](https://mplusfonts.github.io)遵循 SIL OFL 1.1 开源许可，与 IPA 字体授权许可不兼容）；
